    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
            ...
            <div class="bg-white rounded-2xl border border-slate-200 p-5 shadow-sm">
                ...
                @if(!$absensiHariIni)
                    <form action="{{ route('mahasiswa.absensi.checkin') }}" method="POST">
                        @csrf
                        <button type="submit" class="w-full sm:w-auto flex items-center justify-center gap-2 bg-primary hover:bg-primary/90 text-white font-bold py-3 px-6 rounded-xl transition-all shadow-md shadow-primary/20">
                ...
                @elseif($absensiHariIni->jam_masuk && !$absensiHariIni->jam_keluar)
                    <div class="flex flex-wrap gap-3">
                        <div class="flex items-center gap-2 bg-green-50 border border-green-200 text-green-700 px-4 py-2 rounded-xl text-sm font-semibold">
                        ...
                        <form action="{{ route('mahasiswa.absensi.checkout') }}" method="POST">
                            @csrf
                            <button type="submit" class="flex items-center gap-2 border border-slate-300 text-slate-700 font-bold py-2 px-5 rounded-xl hover:bg-slate-50 transition-all text-sm">
                ...
                @else
                    <div class="flex flex-wrap gap-3">
                        ...
                        <div class="flex items-center gap-2 bg-blue-50 border border-blue-200 text-blue-700 px-4 py-2 rounded-xl text-sm font-semibold">
        ...
        <div class="space-y-5">
            ...
            <div class="bg-gradient-to-br from-primary to-blue-700 rounded-2xl p-5 text-white shadow-lg shadow-primary/20">
                ...
                <p class="text-sm text-blue-100 mb-4 leading-relaxed">Hubungi supervisor jika ada kendala teknis.</p>
